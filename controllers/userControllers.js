    ...
    newUser: async (req, res) => {
        ...
        try {
            ...
            if (userExists) {
                ...
                await newUser.save()
                res.json({ success: true, response: { token, newUser, image }, error: null })
    ...
    logIn: async (req, res) => {
        ...
        try {
            ...
            if (!
                ...
                let contraseñaCoincide = bcryptjs.compareSync(password,
                    userExists.password)
                ...
                if (
                    userExists.google && !google) throw new Error("Invalid email");
            }
